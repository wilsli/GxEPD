...
#ifndef _GxGDEW0213T5_H_
#define _GxGDEW0213T5_H_

#include "../GxEPD.h"

#define GxGDEW0213T5_WIDTH 104
#define GxGDEW0213T5_HEIGHT 212

#define GxGDEW0213T5_BUFFER_SIZE (uint32_t(GxGDEW0213T5_WIDTH) * uint32_t(GxGDEW0213T5_HEIGHT) / 8)

// divisor for AVR, should be factor of GxGDEW0213T5_HEIGHT
#define GxGDEW0213T5_PAGES 4

#define GxGDEW0213T5_PAGE_HEIGHT (GxGDEW0213T5_HEIGHT / GxGDEW0213T5_PAGES)
#define GxGDEW0213T5_PAGE_SIZE (GxGDEW0213T5_BUFFER_SIZE / GxGDEW0213T5_PAGES)

class GxGDEW0213T5 : public GxEPD
{
  public:
#if defined(ESP8266)
    //GxGDEW0213T5(GxIO& io, int8_t rst = D4, int8_t busy = D2);
    // use pin numbers, other ESP8266 than Wemos may not use Dx names
    GxGDEW0213T5(GxIO& io, int8_t rst = 2, int8_t busy = 4);
#else
    GxGDEW0213T5(GxIO& io, int8_t rst = 16, int8_t busy = 4);
#endif
    ...
    void powerDown();
    // paged drawing, for limited RAM, drawCallback() is called GxGDEW0213T5_PAGES times
  ...
  private:
#if defined(__AVR)
    uint8_t _buffer[GxGDEW0213T5_PAGE_SIZE];
#else
    uint8_t _buffer[GxGDEW0213T5_BUFFER_SIZE];
#endif
    GxIO& IO;
    ...
    static const unsigned char lut_25[];
    ...
    static const unsigned char lut_25_partial[];
...
#ifndef GxEPD_Class
#define GxEPD_Class GxGDEW0213T5
#define GxEPD_WIDTH GxGDEW0213T5_WIDTH
#define GxEPD_HEIGHT GxGDEW0213T5_HEIGHT
#define GxEPD_BitmapExamples <GxGDEW0213T5/BitmapExamples.h>
#define GxEPD_BitmapExamplesQ "GxGDEW0213T5/BitmapExamples.h"
#endif
